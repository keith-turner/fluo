...
public interface SnapshotBase {
  ...
  /**
   * Given a collection of {@link RowColumn}s, retrieves a map contains the values of those
   * {@link RowColumn}s. Only rows and columns that exists will be returned in map.
   */
